...
- vertrauenswuerdig, aber nicht trocken
- warm und elternnah, aber nicht kitschig
- klar recherchiert, aber nicht akademisch schwer
- kommerziell transparent, aber nicht verkaufsgetrieben

## Aktueller Fit Zur Website

Der aktuelle Stand passt grundsaetzlich gut zum Markenversprechen:
...
Primaere redaktionelle Quelle:

- `docs/design-system/editorial-system.md`
- `bewertungsmethode.html`
- `ueber-uns.html`

## Dokumente

- `brand.md` - Logo, Farben, Typografie, visuelle Haltung
- `components.md` - Layout- und Komponentenregeln
