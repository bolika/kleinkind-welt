...
**Stand:** Versioniertes Produktschema, Katalogmanifest und 20 Modelle sind erfasst. Jeder Fakt besitzt Quellen- und Prüfstatus. Marktstatus und Gesamtpreis laufen ab; unterschiedliche Gewichtsdefinitionen werden über die konkrete Tragekonfiguration getrennt. Der Produktdaten-Gate meldet verbleibende harte Lücken, statt sie zu schätzen. Fünf öffentlich nicht belegbare ungefaltete Wagenbreiten werden zusätzlich in einer versionierten Datenlücken-Registry mit Quelle, Begründung und nächstem Prüfdatum geführt. Modelle mit aktueller Hersteller-Nichtverfügbarkeit erhalten im Ergebnis einen sichtbaren Warnhinweis und ohne frisches Händlerangebot keinen Kauf-CTA. Reisebuggy-, Geschwisterwagen- und Jogger-Routen bleiben technisch getrennt, bis ihre eigenen Kriterien und Datenmodelle belastbar sind. Der Joie Finiti bleibt wegen widersprüchlicher offizieller Setpreise ausdrücklich blockiert.
